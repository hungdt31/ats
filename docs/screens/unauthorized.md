# Tài liệu Đặc tả Màn hình: Không có quyền truy cập
...
| **Tên màn hình** | Không có quyền truy cập |
| **Đường dẫn file** | `app/unauthorized/page.tsx` |
...
### Khái quát chức năng
- **Mục đích:** Trang thông báo lỗi 403 khi người dùng không đủ quyền.
- **User Flow:** 
...
`[Hình ảnh giao diện Không có quyền truy cập]`
